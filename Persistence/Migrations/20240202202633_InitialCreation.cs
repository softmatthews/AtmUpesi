        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrationBank = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OTPAuthentication = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    LastAccessedPages = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastNotificationReadTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserChange", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserChange_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupATM", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupATM_Group_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupRight_Group_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Group",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GroupRight_Right_RightId",
                        column: x => x.RightId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupATM_ATMId_GroupId",
                table: "GroupATM",
                columns: new[] { "ATMId", "GroupId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GroupATM_GroupId",
                table: "GroupATM",
                column: "GroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupRight_RightId_GroupId",
                table: "GroupRight",
                columns: new[] { "RightId", "GroupId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Right_Name_PackageName_Feature",
                table: "Right",
                columns: new[] { "Name", "PackageName", "Feature" },
                unique: true);
